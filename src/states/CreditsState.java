...
class CreditsState implements State {
	...
	public void render(Graphics g) {
		...
		g2d.drawString("Made by",
				(640 - g2d.getFontMetrics().stringWidth("Made by")) / 2.0f,
				260.0f);
		g2d.drawString("Indivisible Man",
				(640 - g2d.getFontMetrics().stringWidth("MikeIndivisible Man"))
						/ 2.0f,
				310.0f);
