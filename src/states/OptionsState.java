...
class OptionsState implements State {
	...
	public void render(Graphics g) {
		...
		g2d.drawString("Currently there are", (640 - g2d.getFontMetrics().stringWidth("Currently there are")) / 2.0f,
				260.0f);
		g2d.drawString("no options to change.",
				(640 - g2d.getFontMetrics().stringWidth("no options to change.")) / 2.0f, 310.0f);
