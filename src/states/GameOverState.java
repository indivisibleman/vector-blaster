...
class GameOverState implements State {
	...
	public void render(Graphics g) {
		...
		g2d.drawString("You Scored", (640 - g2d.getFontMetrics().stringWidth("You Scored")) / 2.0f, 270.0f);
		g2d.drawString(score + "!", (640 - g2d.getFontMetrics().stringWidth(score + "!")) / 2.0f, 310.0f);
